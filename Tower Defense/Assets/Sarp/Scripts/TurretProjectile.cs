...
public class TurretProjectile : MonoBehaviour
{
    ...
    protected ObjectPoolerS _pooler;
    protected Turret _turret;
    protected ProjectileS _currentProjectileLoaded;

    private void Start()
    {
        _turret = GetComponent<Turret>();
        _pooler = GetComponent<ObjectPoolerS>();
    ...
    protected virtual  void LoadProjectile()
    {
        ...
        _currentProjectileLoaded = newInstance.GetComponent<ProjectileS>();
